        ...
        <div className="relative flex group">
          ...
          <div className="flex gap-2">
            <motion.div
              ...
              className={`relative z-10 h-[21.875px] w-[34px] transition-all duration-300 ease-out border ${currentRoute === 'projects' ? " border-purple-600 bg-purple-600": currentRoute === 'skills-and-achievements' ? "border-orange-600 bg-orange-600" : currentRoute==='about' ? "border-red-600 bg-red-600" : "bg-neutral-200 border border-neutral-500"}`}
            ></motion.div>
